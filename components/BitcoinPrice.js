    ...
    if (this.state.currency === "USD") {
      price_desc = (
        <li className="list-group-item">
          ...
          <span className="badge badge-warning">{this.props.bpi.USD.code}</span>
        </li>
      );
      ...
      price_desc = (
        <li className="list-group-item">
          ...
          <span className="badge badge-warning">{this.props.bpi.GBP.code}</span>
        </li>
      );
      ...
      price_desc = (
        <li className="list-group-item">
          ...
          <span className="badge badge-warning">{this.props.bpi.EUR.code}</span>
        </li>
      );
    }
    return (
      <div className="jumbotron" style={{ boxShadow: "2px 3px 11px #333" }}>
        <ul className="list-group">{price_desc}</ul>
        <br />
        <select
